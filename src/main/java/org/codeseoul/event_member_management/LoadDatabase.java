...
class LoadDatabase {
  ...
  CommandLineRunner initDatabase(
    ...
    return args -> {
      ...
      Series newSeries = seriesRepository.save(new Series("New Series"));
      log.info("Preloading " + newSeries);
      log.info("Preloading " + seriesRepository.save(new Series("Another Series")));
      ...
      log.info(
          "Preloading "
              + snsServiceRepository.save(
                  new SnsService("Meetup", "https://meetup.com/favicon.ico")));
      log.info(
          "Preloading "
              + snsServiceRepository.save(
                  new SnsService("Facebook", "https://facebook.com/favicon.ico")));
      log.info("Preloading " + rsvpStateRepository.save(new RsvpState("yes")));
      log.info("Preloading " + rsvpStateRepository.save(new RsvpState("no")));
      log.info("Preloading " + rsvpStateRepository.save(new RsvpState("attended")));
      log.info(
          "Preloading "
