...
@Component
public class MemberModelAssembler
    implements RepresentationModelAssembler<Member, EntityModel<Member>> {

  @Override
  @NonNull public EntityModel<Member> toModel(@NonNull Member member) {
    ...
    return EntityModel.of(
        ...
        linkTo(methodOn(SnsAccountController.class).allForMember(member.getId()))
            .withRel("snsAccounts"));
  }
}
